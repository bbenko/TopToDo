# Django settings for toptodo project.
...
DATABASES = {
    'default': {
        ...
        'NAME': normpath(join(PROJECT_ROOT, 'toptodo.db')),
    }
}
...
SECRET_KEY = '%_2qy@er@bbrz^2uheo8bfcosl4+kli=er+mtfv#25t14hox(1'
...
ROOT_URLCONF = 'toptodo.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'toptodo.wsgi.application'
